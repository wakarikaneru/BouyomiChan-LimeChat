...
//声質の設定
//半角スペースで区切って入力してください([速度] [音程] [音量] [声質]) 
...
var defaultVoiceParam = "-1 -1 -1 0";

//配信者のみ声質を変更するか(true:変更する, false:変更しない)
var bHostVoice = true;

//配信者名
var hostName = "wakarikaneru";

//配信者の声質
var hostVoiceParam = "-1 -1 -1 5";
...
function talkChat(prefix, text) {
	var voiceParam = defaultVoiceParam;
	
	if (bHostVoice){
		if (prefix.nick == hostName){
			voiceParam = hostVoiceParam
		}
	}
